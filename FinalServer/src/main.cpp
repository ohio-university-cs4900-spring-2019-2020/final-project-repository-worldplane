...
#include <vector>
#include <memory>
#include "GLViewFinalServer.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFinalServer > glView( Aftr::GLViewFinalServer::New( args ) );
