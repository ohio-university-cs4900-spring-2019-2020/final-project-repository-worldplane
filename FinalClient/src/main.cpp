...
#include <vector>
#include <memory>
#include "GLViewFinalClient.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFinalClient > glView( Aftr::GLViewFinalClient::New( args ) );
